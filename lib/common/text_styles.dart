...
class CustomTextStyles {
  ...
  static get disbleTS2 => TextStyle(fontSize: 16.0,  fontWeight: FontWeight.bold, color: AppColors.mainTextColor);
  static get activeTS => TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold, color: AppColors.primaryColor); 
